...
let preguntasJson = [
  ...
  },
  {
    ...
    answers: ["Pam Bouvier", "Vanessa Kensington", "Wai Lin", "Mary Goodnight"],
  ...
  },
  {
    ...
    answers: ["Fay Wray", "Mae West", "Jean Harlow", "Vivien Leigh"],
    correct: "Fay Wray",
  },
  {
    question:
      "Which actress danced the twist with John Travolta in 'Pulp Fiction'?",
    answers: ["Kathy Griffin", "Pam Grier", "Bridget Fonda", "Uma Thurman"],
    correct: "Uma Thurman",
  },
  {
    question: 'Who starred in the film 1973 movie "Enter The Dragon"?',
    answers: [" Yun-Fat Chow", "Jackie Chan", "Jet Li", "Bruce Lee"],
    correct: "Bruce Lee",
  },
  {
    question:
  ...
  },
  {
    ...
    answers: ["Flash Gordon", "Labyrinth", "Howard the Duck", "Highlander"],
    correct: "Highlander",
  },
  {
    question: "What was Dorothy's surname in 'The Wizard Of Oz'?",
    answers: ["Parker", "Day", "Perkins", "Gale"],
    correct: "Gale",
  },
  {
    question:
      'This movie contains the quote, "I feel the need ... the need for speed!"',
    answers: ["Top Gun", "Days of Thunder", "The Color of Money", "Cocktail"],
    correct: "Top Gun",
  },
  {
  ...
  },
  {
    ...
    answers: ["AA-A", "BB-3", "BB-8", "R2-D2"],
    correct: "BB-8",
  },
  {
    question: "What was the first James Bond film?",
    answers: ["Goldfinger", "Dr. No", "From Russia With Love", "Thunderball"],
    correct: "Dr. No",
  },
  {
    question: "Which of these movies did Jeff Bridges not star in?",
    answers: ["The Giver", "Tron: Legacy", "True Grit", "The Hateful Eight"],
  ...
  },
  {
    ...
    answers: ["Madison Derpe", "Kim Demp", "Milla Jovovich", "Milla Johnson"],
  ...
  },
  {
    ...
    answers: ["Willy", "Wilson", "Carson", "Jackson"],
    correct: "Wilson",
  },
  {
    question:
  ...
  },
  {
    ...
    answers: ["The Schwartz", "Air", "Meatballs", "Princess Lonestar"],
    correct: "Air",
  },
  {
    question:
      "In the movie Gremlins, after what time of day should you not feed Mogwai?",
    answers: ["Midnight", "Morning", "Evening", "Afternoon"],
    correct: "Midnight",
  },
  {
    question:
  ...
  },
  {
    ...
    answers: ["Grammy Norma", "The Once-Ler", "Ted Wiggins", "Aloysius O'Hare"],
    correct: "Aloysius O'Hare",
  },
  {
    question:
      'At the end of the 2001 film "Rat Race", whose concert do the contestants crash?',
    answers: ["Sum 41", "Smash Mouth", "Linkin Park", "Bowling for Soup"],
    correct: "Smash Mouth",
  },
  {
  ...
  },
  {
    ...
    answers: ["Japanese", "Nordic", "Polynesian", "Native American"],
    correct: "Polynesian",
  },
  {
  ...
  },
  {
    ...
    answers: ["Ming Tea", "Spear Mint", "Mister E", "Cough Fi"],
    correct: "Ming Tea",
  },
  {
  ...
  {
    question:
      "Which of the following actors has only been in a Quentin Tarantino directed film once?",
    answers: [
      "Christoph Waltz",
      "John Travolta",
      "Harvey Keitel",
  ...
  {
    question:
      "What historical time period was the center of the Assassin’s Creed movie (2016)?",
    answers: [
      "Victorian England",
      "Spanish Inquisition",
      "Colonial America",
  ...
  },
  {
    ...
    answers: ["November 4th", "September 5th", "November 6th", "November 5th"],
    correct: "November 5th",
  },
];

//console.log(Object.values(preguntasJson[46]));
/* const h2 = document.querySelector("h2");
for (const elemento of preguntasJson) {
    //console.log(elemento.question);
    h2.innerHTML = `<h2>${elemento.question}</h2>`;
    //NECESITAMOS UNA ASINCRONA PARA DETENER EL BUCLE HASTA TENER LA RESPUESTA
} */
